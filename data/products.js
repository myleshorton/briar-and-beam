export const products = [
  ...
  },
  {
    ...
    category: 'Side Table',
    description: 'A small side table drawn from memory — scalloped edges I once fell in love with and never forgot. The Aubrey is a quiet thing, small enough for a bedside and beautiful enough to live in any room of the house. Built in solid walnut to last well past a single lifetime.',
    woodOptions: [
      { name: 'White Oak', priceAdjust: 0 },
  ...
  },
  {
    ...
    category: 'Side Table',
    description: 'The Juniper is The Aubrey\'s little sister — no drawer, no fuss, just as elegant and effortlessly simple. She tucks into an entryway or lines a hallway without saying too much, but you\'ll notice her every time you walk by.',
    woodOptions: [
      { name: 'White Oak', priceAdjust: 0 },
      { name: 'Walnut', priceAdjust: 200 }
    ],
